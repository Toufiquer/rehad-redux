...
import { toast } from "react-toastify";
import { adminLoggedIn } from "../../redux/features/adminAuth/adminAuthSlice";
...
const AdminLogIn = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      dispatch(adminLoggedIn(currentUser));
      getSaveToLocalStorage("adminAuth", currentUser);
